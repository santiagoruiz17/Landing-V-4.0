        ...
        <section id="calendar" className="py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center mb-16">
                    <h2 className="text-3xl md:text-4xl font-serif text-charcoal mb-4">Agenda tu sesión de asesoría financiera empresarial</h2>
                    <p className="text-gray-600 max-w-2xl mx-auto">
                        Selecciona el horario que mejor se adapte a ti. Sin costo, sin compromiso.
                    </p>
                </div>
