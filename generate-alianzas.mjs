...
<body>
  ...
  <main class="partner-content">
    ...
    <a href="/perfil" class="contact-btn">
      Califícate hoy mismo
      <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M13 7l5 5m0 0l-5 5m5-5H6"/></svg>
    </a>
  </main>
