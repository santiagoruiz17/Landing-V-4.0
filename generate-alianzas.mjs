...
<head>
  ...
  <style>
    *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .nav-back { display: flex; align-items: center; gap: 8px; font-size: 0.875rem; font-weight: 500; color: var(--gray-text); text-decoration: none; transition: all 0.2s; padding: 8px 20px; border: 1px solid var(--gray-border); border-radius: 8px; }
    .nav-back:hover { color: var(--green); border-color: var(--green); background: var(--green-light); }
...
<body>
  ...
  <nav class="navbar">
    <div class="navbar-inner">
      ...
      <a href="/alianzas/" class="nav-back">
